 ...
 *	Youtube:  https://youtu.be/A5ZZWq0KYwA
 *  Exercise Description:
 *
 *  I need to create a system that allows for the shifting of entire columes
 *  of LEDs on the matrix, not allowing overflow.
 *
 *
...
unsigned char col_level = 0;  // current col level on matrix
