    ...
    switch(state) {
        ...
        case SM4_Draw:
            ...
            if (drawFrame == 4) {
              ...
              // draw using registers
              transmit_data(row_valSquare[drawFrame], 1);
              transmit_data(row_selSquare[drawFrame], 2);
              drawFrame = 0;
            } else {
